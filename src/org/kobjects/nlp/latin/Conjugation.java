...
class Conjugation {
  static final Map<Form, String[]> PERSONAL_SUFFIXES = new HashMap<Form, String[]>();
  {
    PERSONAL_SUFFIXES.put(Form.IND_IMPERF_ACT, splitAndTrim("am,as,at,amus,atis,ant", ","));
    PERSONAL_SUFFIXES.put(Form.IND_IMPERF_PASS, splitAndTrim("bar,baris,batur,bamur,bamini,bantur", ","));
    PERSONAL_SUFFIXES.put(Form.SJV_PRES_ACT, splitAndTrim("m,s,t,mus,tis,nt", ","));
    PERSONAL_SUFFIXES.put(Form.SJV_PRES_PASS, splitAndTrim("r,ris,tur,mur,mini,ntur", ","));
    PERSONAL_SUFFIXES.put(Form.SJV_IMPERF_ACT, splitAndTrim("em,es,et,emus,etis,ent", ","));
    PERSONAL_SUFFIXES.put(Form.SJV_IMPERF_PASS, splitAndTrim("rer,reris,retur,remur,remini,rentur", ","));
  }
  ...
  static final Conjugation FERRE = new Conjugation(
      ...
      Form.IND_IMPERF_PASS, "fere",  // +Personal
  ...
  static String[] splitAndTrim(String s, String deli) {
