...
const readEsseStream = fs.createReadStream(path.join(inputDirPath, "esse.lat"), "latin1");
const readExtensionsStream = fs.createReadStream(path.join(inputDirPath, "extensions.lat"), "utf8");
readStream.append(readMainStream);
readStream.append(readEsseStream);
